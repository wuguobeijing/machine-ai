...
batch_size = 1
lr=0.1
# 5个单词，1个batch，每个单词用3维向量表达
idx2char = ['h','l','o']
x_data = [1,2,1,1,2]
y_data = [2,0,1,2,1]
one_hot_lookup = [[1,0,0],[0,1,0],[0,0,1]]
...
net1 = Model1(input_size,hidden_size,batch_size, num_layers=2)
...
for epoch in range(9):
    ...
    print(',Epoch [%d/9] loss=%.3f' % (epoch+1, loss.item()))